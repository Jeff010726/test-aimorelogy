  ...
  return (
    <div className="group bg-white flex flex-col h-full border border-gray-200 hover:shadow-xl hover:border-[#4f4398] transition-all duration-300">
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <a href="#" className="inline-block text-gray-900 font-bold text-sm uppercase hover:text-[#4f4398] transition-colors underline decoration-[#4f4398] decoration-2 underline-offset-4">
          Read Story
        </a>
      </div>
    </div>
